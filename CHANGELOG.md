...
* [FeedReader module](https://wtfutil.com/modules/feedreader/) now displays the name of the parent feed in front of the feed item, [#1138](https://github.com/doctorfree/wtf/issues/1138) by [@igbanam](https://github.com/igbanam)
* Steam Status module added by [@despreston](https://github.com/despreston)
* Working directory option for CmdRunner, [#1293](https://github.com/doctorfree/wtf/issues/1293) by [@Seanstoppable](https://github.com/Seanstoppable)
...
* [Football](https://wtfutil.com/modules/sports/football/) module now uses HTTPS to connect to API, [#1183](https://github.com/doctorfree/wtf/issues/1183) by [@despreston](https://github.com/despreston)
...
* Typing "q" no longer quits the entire app every time, [#1257](https://github.com/doctorfree/wtf/issues/1257) by [@senorprogrammer](https://github.com/senorprogrammer)
* Row highlighting properly terminates the highlight color, [#1280](https://github.com/doctorfree/wtf/issues/1280) by [@Seanstoppable](https://github.com/Seanstoppable)
* Textfile widget properly displays text inside square brackets
* CmdRunner doesn't continue to keep around processes in pty mode [#1225](https://github.com/doctorfree/wtf/issues/1225) by [@Seanstoppable](https://github.com/Seanstoppable)
* Fix tag filtering in Todo module [#1172](https://github.com/doctorfree/wtf/issues/1225) by [@Seanstoppable](https://github.com/Seanstoppable)

## 0.41.0

### 🐞 Fixed

* [Kubernetes module](https://wtfutil.com/modules/kubernetes/) now uses a client per widget, rather than a global client, [#1081](https://github.com/doctorfree/wtf/issues/1081) by [@hypnoglow](https://github.com/hypnoglow)
* [FeedReader module]() now supports basic auth, [#957](https://github.com/doctorfree/wtf/issues/957) by [@ResamVi](https://github.com/ResamVi)
* Single words inside square brackets are displayed in the [CmdRunner module](https://wtfutil.com/modules/cmdrunner/), [#1142](https://github.com/doctorfree/wtf/issues/1142) by [@yosmoc](https://github.com/yosmoc)
...
* Numerous improvements to the display of the Git module, [#1102](https://github.com/doctorfree/wtf/pull/1102) by [@tadeaspaule](https://github.com/tadeaspaule)
* Updated to Go 1.17, by [nontw](https://github.com/nontw)
* [Airbrake module](https://github.com/doctorfree/wtf/tree/master/modules/airbrake) added, by [@kyrylo](https://github.com/kyrylo)
* Displays the battery level of connected devices, if the level can be read by `ioreg`, on MacOS, [#1108](https://github.com/doctorfree/wtf/issues/1108) by [@senorprogrammer](https://github.com/senorprogrammer)
...
* [Security module](https://wtfutil.com/modules/security/) no longer displays wifi info if wifi is missing or disabled, [#1124](https://github.com/doctorfree/wtf/issues/1124) by [@yosmoc](https://github.com/yosmoc)
* `q` now quits WTF. Added as a new global hotkey, by [@thuan1412](https://github.com/thuan1412)
* [DigitalOcean module](https://wtfutil.com/modules/digitalocean/) now properly displays the droplet region, [#1053](https://github.com/doctorfree/wtf/issues/1053) by [@yosmoc](https://github.com/yosmoc)
* [gCal module](https://wtfutil.com/modules/google/gcal/) now supports multiple configurations with different email addresses, [#1016](https://github.com/doctorfree/wtf/issues/1016) by [@Seanstoppable](https://github.com/Seanstoppable)
* All modules now support sub-1 second refresh intervals by specifying an optional time unit (ie: `50ms`, `20s`), [#1103](https://github.com/doctorfree/wtf/issues/1103) by [@ResamVi](https://github.com/ResamVi)
...
* `make lint` errors fixed, [#1127](https://github.com/doctorfree/wtf/issues/1127) by [@yosmoc](https://github.com/yosmoc)
* `jwt-go` replaced by `golang-jwt`, because security vulnerabilities, [#1121](https://github.com/doctorfree/wtf/issues/1121) by [@siddhant94](https://github.com/siddhant94)
...
* [Updown module](https://github.com/doctorfree/wtf/tree/master/modules/updown) added, by [@hjr265](https://github.com/hjr265)
* Considerable improvements to the [Todo module](https://github.com/doctorfree/wtf/tree/master/modules/todo). See PR [#1100](https://github.com/doctorfree/wtf/pull/1100) for details. By [@tadeaspaule](https://github.com/tadeaspaule)

### 🐞 Fixed

* [Healthchecks module](https://github.com/doctorfree/wtf/tree/master/modules/healthchecks) now respects the `apiURL` setting in the config file, by [@hjr265](https://github.com/hjr265)
* Example FeedReader RSS feed in the default config changed to a working feed, [#1096](https://github.com/doctorfree/wtf/issues/1096) by [@senorprogrammer](https://github.com/senorprogrammer)

## 0.38.0

### 🐞 Fixed

* [FeedReader module](https://github.com/doctorfree/wtf/tree/master/modules/feedreader) handles line breaks in item titles gracefully, [#1088](https://github.com/doctorfree/wtf/issues/1088) by [@GibranHL0](https://github.com/GibranHL0)

## 0.37.0

### ⚡️ Added

* [Yahoo Finance](https://github.com/doctorfree/wtf/tree/master/modules/stocks/yfinance) module added, by [@inetAnt](https://github.com/inetAnt)

### 🐞 Fixed

* Fixed error closing the Jira module response body, [#1070](https://github.com/doctorfree/wtf/issues/1070) by [@senorprogrammer](https://github.com/senorprogrammer)

## v0.36.0

### ⚡️ Added

* [Healthchecks module](https://github.com/doctorfree/wtf/tree/master/modules/healthchecks) added, by [@stone](https://github.com/stone)
* [Asana module](https://github.com/doctorfree/wtf/tree/master/modules/asana) added, by [@xntrik](https://github.com/xntrik)
* [Kubernetes module](https://github.com/doctorfree/wtf/tree/master/modules/kubernetes) now displays the Ready Replicas and Total Replicas count, by [@LKaemmerling](https://github.com/LKaemmerling)
...
* CircleCI module now supports `numberOfBuilds` setting defining how many builds to display, [#1020](https://github.com/doctorfree/wtf/issues/1020) by [@dabcoder](https://github.com/dabcoder)
...
* CryptoLive prices update again, [#1041](https://github.com/doctorfree/wtf/issues/1041) by [@zye1996](https://github.com/zye1996)
...
* DigitalOcean module now supports custom column definitions in the default layout. See [the docs](https://wtfutil.com/modules/digitalocean/) for details, [#986](https://github.com/doctorfree/wtf/issues/986) by [@senorprogrammer](https://github.com/senorprogrammer)
* Finnhub stock quotes module added, [#930](https://github.com/doctorfree/wtf/issues/930) by [@applegreengrape](https://github.com/applegreengrape)
...
* FeedReader module supports [display mode switching](https://github.com/doctorfree/wtf/pull/976) via the `t` key, by [@cyingfan](https://github.com/cyingfan)
* Clocks module now supports `natural` ordering option, [#896](https://github.com/doctorfree/wtf/issues/896) by [@seanstoppable](https://github.com/Seanstoppable)
* Exit banner message added, by [@senorprogrammer](https://github.com/senorprogrammer)
* [UptimeRobot module added](https://github.com/doctorfree/wtf/pull/983), by [@franga2000](https://github.com/franga2000)
...
* Feed Reader module no longer crashes on feeds that don't have a published date, [#958](https://github.com/doctorfree/wtf/issues/958) by [@cyingfan](https://github.com/cyingfan)
* Stray blank lines no longer appear at the end of highlightable lists, [#977](https://github.com/doctorfree/wtf/pull/977) by [@cyingfan](https://github.com/cyingfan)
* `config.yml` now properly set to `0600` instead of `0666`, by [@cyingfan](https://github.com/cyingfan)
* Now blank-imports the `time/tzinfo` package to provide timezone support for Windows users, [#994](https://github.com/doctorfree/wtf/issues/994) by [@trimble](https://github.com/trimble)
...
* Exchange Rates module now supports `precision` setting, which determines how many decimal places to display, [#897](https://github.com/doctorfree/wtf/issues/897) by [@senorprogrammer](https://github.com/senorprogrammer)

### 🐞 Fixed

* Todo module's edit modal now shows up quickly, [#876](https://github.com/doctorfree/wtf/issues/876) by [@aeter](https://github.com/aeter)
* Jira module title now displays properly, [#942](https://github.com/doctorfree/wtf/issues/942) by [@timhwang21](https://github.com/timhwang21)
...
* [docker-credential-helpers](https://github.com/docker/docker-credential-helpers) support added to provide optional securing of module secrets, [#517](https://github.com/doctorfree/wtf/issues/517) by [@sam-github](https://github.com/sam-github)
...
* GitHub module now supports per-section configuration, [#864](https://github.com/doctorfree/wtf/issues/864) by [@mryanmurphy](https://github.com/mryanmurphy)
...
* The GitHub repo now runs a set of actions that lint PRs for code quality and conformity and comment in-line on the PRs. See here for action details https://github.com/doctorfree/wtf/actions

### 🐞 Fixed

* Random capital letters around display, [#811](https://github.com/doctorfree/wtf/issues/811) by [@jonhadfield](https://github.com/jonhadfield)
...
* Docker module subheading display, [#847](https://github.com/doctorfree/wtf/issues/847) by [@senorprogrammer](https://github.com/senorprogrammer)
...
* The `vendor` directory has been removed, [#792](https://github.com/doctorfree/wtf/issues/792) by [@bjoernw](https://github.com/bjoernw)
...
* HackerNews module now opens HN comments when there is no alternative external link, [#758](https://github.com/doctorfree/wtf/issues/758) by [@senorprogrammer](https://github.com/senorprogrammer)
* gCal module now now allows users to hide all-day events, [#733](https://github.com/doctorfree/wtf/issues/733) by [@senorprogrammer](https://github.com/senorprogrammer)
* SpaceX module added, by [@bjoernw](https://github.com/bjoernw)
* Support for obeying `XDG_CONFIG_HOME` when set, [#699](https://github.com/doctorfree/wtf/issues/699) by [@Seanstoppable](https://github.com/Seanstoppable)

### 🐞 Fixed

* Module templating working again, [#748](https://github.com/doctorfree/wtf/issues/748) by [@senorprogrammer](https://github.com/senorprogrammer)
* CmdRunner title spacing issue fixed, [#784](https://github.com/doctorfree/wtf/issues/784) by [@senorprogrammer](https://github.com/senorprogrammer)
* Colors in cmdrunner fixed when using nodejs chalk et al., [#618](https://github.com/doctorfree/wtf/issues/618) by [@Seanstoppable](https://github.com/Seanstoppable)
* Docker buid instructions updated and improved, by [@firecat53](https://github.com/firecat53)
* Kubernetes module can now be used with multiple contexts, [#809](https://github.com/doctorfree/wtf/issues/809) by [@davidsbond](https://github.com/davidsbond)
...
* Subreddit out of bounds error fixed, [#753](https://github.com/doctorfree/wtf/issues/753) by [@TDHTTTT](https://github.com/TDHTTTT)
* Homebrew builds now contain version information, [#557](https://github.com/doctorfree/wtf/issues/557) by [@jottr](https://github.com/jottr)
* CmdRunner flicker problem, [#732](https://github.com/doctorfree/wtf/issues/732) by [@Gibstick](https://github.com/Gibstick)
...
* Proper, usable [Docker file](https://github.com/doctorfree/wtf/blob/master/Dockerfile) added, by [@Boot-Error](https://github.com/Boot-Error)
...
* Todo scrolling now works properly, [#707](https://github.com/doctorfree/wtf/issues/707) by [3mard](https://github.com/3mard)
* Configs with a missing `color` key now load properly, [#718](https://github.com/doctorfree/wtf/issues/718) and [#730](https://github.com/doctorfree/wtf/issues/730) by [@senorprogrammer](https://github.com/senorprogrammer)
...
* [TravisCI]() module now supports enterprise endpoints, [#652](https://github.com/doctorfree/wtf/issues/652) by [@scw007](https://github.com/scw007)
* [Subreddit](https://wtfutil.com/modules/subreddit/) module added, by [@lawrencecraft](https://github.com/lawrencecraft)
* [gCal](https://wtfutil.com/modules/google/gcal/) module now supports a `hourFormat` setting for defining whether to display 12 or 24-hour times, [#665](https://github.com/doctorfree/wtf/issues/665) by [@senorprogrammer](https://github.com/senorprogrammer)
* [Scarf](https://scarf.sh) installation instructions added to README, by [@aviaviavi](https://github.com/aviaviavi)
* Spotify widget now supports colour themes, [#659](https://github.com/doctorfree/wtf/issues/659) by [@Tardog](https://github.com/Tardog)
* [Buildkite](https://wtfutil.com/modules/buildkite/) module added, by [@jmks](https://github.com/jmks)
* [Improvements](https://github.com/doctorfree/wtf/pull/680) to the [CmdRunner](https://wtfutil.com/modules/cmdrunner/) module, by [@noxer](https://github.com/noxer)

### 🐞 Fixed

* gCal calendar event time colour can now be changed by setting the `eventTime` configuration setting, [#638](https://github.com/doctorfree/wtf/issues/638) by [@indradhanush](https://github.com/indradhanush)
* [Clocks](https://wtfutil.com/modules/clocks/) now obeys global row colour settings, [#658](https://github.com/doctorfree/wtf/issues/658) by [@senorprogrammer](https://github.com/senorprogrammer)
* [Transmission](https://wtfutil.com/modules/transmission/) module no longer blocks rendering when a Transmission daemon cannot be found, [#661](https://github.com/doctorfree/wtf/issues/661) by [@senorprogrammer](https://github.com/senorprogrammer)
* [Trello](https://wtfutil.com/modules/trello/) module now respects project list order, [#664](https://github.com/doctorfree/wtf/issues/664) by [@Seanstoppable](https://github.com/Seanstoppable)
* [Todo](https://wtfutil.com/modules/todo/) module now respects checkbox settings, [#616](https://github.com/doctorfree/wtf/issues/616) by [@Seanstoppable](https://github.com/Seanstoppable)
* [Todoist](https://wtfutil.com/modules/todoist/) module now properly handles todo items with due date and times, [#645](https://github.com/doctorfree/wtf/issues/645) by [@massa1240](https://github.com/massa1240)
...
* Google Analytics module now supports real-time metrics, [#581](https://github.com/doctorfree/wtf/issues/581) by [@Ameobea](https://github.com/Ameobea)
...
* GitHub module pull requests are now selectable and openable via keyboard, [#547](https://github.com/doctorfree/wtf/issues/547) by [@Midnight-Conqueror](https://github.com/Midnight-Conqueror)
* [Docker](https://wtfutil.com/modules/docker/) module added, [#594](https://github.com/doctorfree/wtf/issues/594) by [@v-braun](https://github.com/v-braun)
* NewRelic module now supports displaying data from multiple apps, [#471](https://github.com/doctorfree/wtf/issues/471) by [@ChrisDBrown](https://github.com/ChrisDBrown) and [@Seanstoppable](https://github.com/Seanstoppable)
* [Digital Clock](https://wtfutil.com/modules/digitalclock/) module added, by [@Narengowda](https://github.com/Narengowda)

### 🐞 Fixed

* ScrollableWidget bounds checking error fixed, [#578](https://github.com/doctorfree/wtf/issues/578) by [@Seanstoppable](https://github.com/Seanstoppable)
* Now properly URL-decodes Jenkins branch names, [#575](https://github.com/doctorfree/wtf/issues/575) by [@lesteenman](https://github.com/lesteenman)
* Jira column sizes render properly, [#574](https://github.com/doctorfree/wtf/issues/574) by [@lesteenman](https://github.com/lesteenman)
* Todoist module updated to latest API version, by [@Seanstoppable](https://github.com/Seanstoppable)
* gCal colour highlighting working again, [#611](https://github.com/doctorfree/wtf/issues/611) by [@senorprogrammer](https://github.com/senorprogrammer)
* Per-module background and text colour settings working again, [#568](https://github.com/doctorfree/wtf/issues/568) by [@Seanstoppable](https://github.com/Seanstoppable)
* Git module no longer forces sorting of repositories, [#608](https://github.com/doctorfree/wtf/pull/608) by [@Seanstoppable](https://github.com/Seanstoppable)
* GitHub PR icons render properly without phantom characters, by [@Midnight-Conqueror](https://github.com/Midnight-Conqueror)
* GitLab configuration now takes a list of project paths, [#566](https://github.com/doctorfree/wtf/issues/566) by [@senorprogrammer](https://github.com/senorprogrammer)
* Kubernetes configuration segfault fixed, [#549](https://github.com/doctorfree/wtf/issues/549) by [@ibaum](https://github.com/ibaum)
...
* Power indicator displays ∞ on Linux when fully-charged and on AC power, [#534](https://github.com/doctorfree/wtf/issues/534) by [@Seanstoppable](https://github.com/Seanstoppable)
...
* Transmission port over-ride now working, [#565](https://github.com/doctorfree/wtf/issues/565) by [@Seanstoppable](https://github.com/Seanstoppable)
* Default config is now created on first run, [#553](https://github.com/doctorfree/wtf/issues/553) by [@senorprogrammer](https://github.com/senorprogrammer)

## v0.20.0

### ⚡️ Added

* Kubernetes module added, [#142](https://github.com/doctorfree/wtf/issues/142) by [@sudermanjr](https://github.com/sudermanjr)

### 🐞 Fixed

* Tab and Esc keys work properly in modal dialogs, [#520](https://github.com/doctorfree/wtf/issues/520) by [@Seanstoppable](https://github.com/Seanstoppable)
* `wtfutil -m` flag now works with non-enabled modules, [#529](https://github.com/doctorfree/wtf/issues/529) by [@Seanstoppable](https://github.com/Seanstoppable)
* Jenkins job filtering preserved across redraws, [#532](https://github.com/doctorfree/wtf/issues/532) by [@Seanstoppable](https://github.com/Seanstoppable)
...
* HIBP module now requires an API key to operate. See [Authentication and the Have I Been Pwned API](https://www.troyhunt.com/authentication-and-the-have-i-been-pwned-api/) for more details, [#508](https://github.com/doctorfree/wtf/issues/508) by [@senorprogrammer](https://github.com/senorprogrammer)
...
* Rollbar module works again, [#507](https://github.com/doctorfree/wtf/issues/507) by [@Seanstoppable](https://github.com/Seanstoppable)
* The default config that gets installed on first run is much improved, [#504](https://github.com/doctorfree/wtf/issues/504) by [@senorprogrammer](https://github.com/senorprogrammer)
...
* Now created ~/.config if that directory is missing, [#510](https://github.com/doctorfree/wtf/issues/510) by [@senorprogrammer](https://github.com/senorprogrammer)
...
* Cryptolive module works again, [#481](https://github.com/doctorfree/wtf/issues/481) by [@Seanstoppable](https://github.com/Seanstoppable)
* gCal module now supports setting an explicit time zone via the "timezone" config attribute, [#382](https://github.com/doctorfree/wtf/issues/382) by [@jeangovil](https://github.com/jeangovil)
* Misconfigured module positions in `config.yaml` now attempt to provide informative error messages on launch, [#482](https://github.com/doctorfree/wtf/issues/482)
...
* Keyboard modal displays properly when tabbing between widgets, [#467](https://github.com/doctorfree/wtf/issues/467)
...
* Gitlab no longer prevents installing with missing param, [#455](https://github.com/doctorfree/wtf/issues/455)

## v0.10.1

### 🐞 Fixed

* Trello now displays multiple lists properly, [#454](https://github.com/doctorfree/wtf/issues/454)
...
* Focusable hot key numbers are now assigned in a stable order, [#435](https://github.com/doctorfree/wtf/issues/435) by [@Seanstoppable](https://github.com/Seanstoppable)
...
* Dependencies are now managed and installed using Go modules. See README.md for details, [#406](https://github.com/doctorfree/wtf/issues/406) by [@retgits](https://github.com/retgits)

## 0.7.2

### ⚡️ Added

* NBA Scores now navigable via arrow keys, [#415](https://github.com/doctorfree/wtf/issues/415)

### 🐞 Fixed

* Multi-page sigils off-by-one error fixed, [#413](https://github.com/doctorfree/wtf/issues/413)
...
* HackerNews row selections are visible again, [#411](https://github.com/doctorfree/wtf/issues/411)

## 0.7.0

### ⚡️ Added

* Jenkins now supports coloured balls, [#358](https://github.com/doctorfree/wtf/issues/358) by [@rudolphjacksonm](https://github.com/rudolphjacksonm)
* Jenkins now supports regular expressions, [#359](https://github.com/doctorfree/wtf/issues/359) by [@rudolphjacksonm](https://github.com/rudolphjacksonm)
...
* Now displays an error on start-up if a widget has mis-configured `position` attributes ([#389](https://github.com/doctorfree/wtf/issues/389) by @senporprogrammer)
...
* Recursive repo search in Git module ([#126](https://github.com/doctorfree/wtf/issues/126) by [@anandsudhir](http://github.com/anandsudhir))
...
* Google Calendar module now displays all-day events ([#306](https://github.com/doctorfree/wtf/issues/306) by [@nicholas-eden](https://github.com/nicholas-eden))
* Google Calendar configuration much improved ([#326](https://github.com/doctorfree/wtf/issues/326) by [@dvdmssmnn](https://github.com/dvdmssmnn))
...
* Textfile module now watches files for changes ([#276](https://github.com/doctorfree/wtf/issues/276) by @senporprogrammer)
...
* Textfile syntax highlighting now included in stand-alone binary ([#261](https://github.com/doctorfree/wtf/issues/261) by @senporprogrammer)
* Config param now supports relative paths starting with `~` ([#295](https://github.com/doctorfree/wtf/issues/295) by @anandsudhir)
...
* Pretty Weather properly displays colours again (([#298](https://github.com/doctorfree/wtf/issues/298) by @bertl4398)
* Clocks row colour configuration fixed (([#282](https://github.com/doctorfree/wtf/issues/282) by @anandsudhir)
* Sigils no longer display when there's only one option (([#291](https://github.com/doctorfree/wtf/issues/291) by @anandsudhir)
* Jira module now responds to the "/" key (([#268](https://github.com/doctorfree/wtf/issues/268)) by @senorprogrammer)
